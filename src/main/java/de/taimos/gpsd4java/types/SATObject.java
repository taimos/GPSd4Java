...
public class SATObject implements IGPSObject {
  ...
  /**
   * PRN ID of the satellite. 1-63 are GNSS satellites, 64-96 are GLONASS satellites, 100-164 are
   * SBAS satellites
   *
   * @return PRN
   */
  ...
  /**
   * Used in current solution? (SBAS/WAAS/EGNOS satellites may be flagged used if the solution has
  ...
  public boolean equals(final Object obj) {
    ...
    if (Double.doubleToLongBits(this.signalStrength)
        != Double.doubleToLongBits(other.signalStrength)) {
      return false;
    }
