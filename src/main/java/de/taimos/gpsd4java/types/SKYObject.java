...
public class SKYObject implements IGPSObject {
  ...
  /**
   * Altitude dilution of precision, a dimensionless factor which should be multiplied by a base
   * UERE to get an error estimate.
   *
  ...
  /**
   * Time dilution of precision, a dimensionless factor which should be multiplied by a base UERE to
  ...
  /**
   * Spherical dilution of precision, a dimensionless factor which should be multiplied by a base
   * UERE to get an error estimate.
   *
  ...
  /**
   * Hyperspherical dilution of precision, a dimensionless factor which should be multiplied by a
  ...
  public boolean equals(final Object obj) {
    ...
    if (Double.doubleToLongBits(this.horizontalDOP)
        != Double.doubleToLongBits(other.horizontalDOP)) {
      return false;
    }
    if (Double.doubleToLongBits(this.hypersphericalDOP)
        != Double.doubleToLongBits(other.hypersphericalDOP)) {
      return false;
    }
