...
/**
 * An ATT object is a vehicle-attitude report. It is returned by digital-compass and gyroscope
 * sensors; depending on device, it may include: heading, pitch, roll, yaw, gyroscope, and
 * magnetic-field readings. Because such sensors are often bundled as part of marine-navigation
 * systems, the ATT response may also include water depth.<br>
 * <br>
 *
 * <p>all getters for double values may return <code>Double.NaN</code> if value is not present<br>
